...
class MyFrame(wx.Frame):# this is the parent frame
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(1, _("Refresh IGGEQAdb"), "", wx.ITEM_NORMAL)
        self.frame_1_menubar.Append(wxglade_tmp_menu,_("Activities"))
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(2, _("Readiness"), "", wx.ITEM_NORMAL)
        self.frame_1_menubar.Append(wxglade_tmp_menu,_("Reports"))
